...
{
    public partial class AddAddressesAndCrossReferencesTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    xref_key = table.Column<string>(maxLength: 14, nullable: false),
                    uprn = table.Column<long>(nullable: false),
                    xref_code = table.Column<string>(maxLength: 6, nullable: true),
                    xref_name = table.Column<string>(maxLength: 100, nullable: true),
                    xref_value = table.Column<string>(maxLength: 50, nullable: true),
                    xref_end_date = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_hackney_xref", x => x.xref_key);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_national_address", x => x.lpi_key);
                });
        }
